...
<meta charset="utf-8">
   ...
   <body>
       <div id="popup-search-box-id" class="popup-search-box">
        ...
        </div>     <div class="login-page-content-area section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        ...
                        <div class="login-form-div">
                            <form action="https://formspree.io/rabukushtia@gmail.com" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <input type="checkbox" name="checkbox" id="login-checkbox" value="value">
                                        <label for="login-checkbox">Remember me</label>
                                    </div>
                                    <div class="col-xs-6 text-right">
                                        <a href="#" class="login-forgot-btn">Forgot password?</a>
                                    </div>
                                </div>
